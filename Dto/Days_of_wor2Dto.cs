   ...
   public class Days_of_wor2Dto
    {
        ...
        public static Days_of_wor2Dto DalToDto(days_of_wor2 d)
        {
            return new Days_of_wor2Dto()
            {
                iddayw = d.iddayw,
                idwor = d.idwor,
                days = new bool[] { d.isSunday.Value, d.isManday.Value, d.isTuthday.Value, d.isWenthday.Value, d.isThursday.Value, d.isFriday.Value, d.isShabbat.Value },
            ...
            d.hourstartw = this.hourstartw;
            d.hourendw = this.hourendw;
            d.isavliable = this.isavliable;
            d.confid = this.confid;
            return d;
